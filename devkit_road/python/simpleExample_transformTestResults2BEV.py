...
if __name__ == "__main__":
    ...
    datasetDir = '/home/haolin/RD/tool/devkit_road/python/kitti_road/'
    # outputDir_perspective = '/home/haolin/RD/tool/devkit_road/python/kitti_road/results/train_baseline_perspective'
    outputDir_bev = '/home/haolin/RD/tool/devkit_road/python/kitti_road/results/train_baseline_bev'
    outputDir = '/home/haolin/RD/tool/devkit_road/python/kitti_road/results/'
    ...
    # path2data
    testData_pathToCalib = os.path.join(datasetDir, 'training/calib')
    outputDir_perspective = os.path.join(outputDir, 'baseline_perspective_train')
    outputDir_bev = os.path.join(outputDir, 'baseline_bev_train')
